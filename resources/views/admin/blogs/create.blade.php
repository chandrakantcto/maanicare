                        ...
                        <form action="{{ route('admin.blogs.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('category_id') is-invalid @enderror" id="category_id" name="category_id">
                                            <option value="0" {{ old('category_id', '0') == '0' ? 'selected' : '' }}>— None —</option>
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('author_id') is-invalid @enderror" id="author_id" name="author_id">
                                            <option value="0" {{ old('author_id', '0') == '0' ? 'selected' : '' }}>— Current user —</option>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('reading_time_minutes') is-invalid @enderror"
                                            id="reading_time_minutes" name="reading_time_minutes" value="{{ old('reading_time_minutes') }}" min="0">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('tags') is-invalid @enderror"
                                    id="tags" name="tags" value="{{ old('tags') }}" placeholder="Comma-separated, e.g. Laravel, PHP, Web">
                                @error('tags')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
