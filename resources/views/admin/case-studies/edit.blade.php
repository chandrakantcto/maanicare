            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.case-studies.update', $case_study) }}" method="POST" enctype="multipart/form-data" id="case-study-form">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('title') is-invalid @enderror"
                                            id="title" name="title" value="{{ old('title', $case_study->title) }}" required>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('category_id') is-invalid @enderror" id="category_id" name="category_id">
                                            ...
                                            @foreach($categories as $c)
                                                <option value="{{ $c->id }}" {{ old('category_id', $case_study->category_id) == $c->id ? 'selected' : '' }}>{{ $c->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('category_id')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('subtitle') is-invalid @enderror"
                                            id="subtitle" name="subtitle" value="{{ old('subtitle', $case_study->subtitle) }}">
                                        @error('subtitle')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                @if($case_study->hero_image)
                                    <small class="d-block mt-1">Current: <a href="{{ asset('storage/' . $case_study->hero_image) }}" target="_blank">View</a></small>
                                @endif
                                @error('hero_image')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('short_description') is-invalid @enderror"
                                    id="short_description" name="short_description" rows="3">{{ old('short_description', $case_study->short_description) }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('vision_heading') is-invalid @enderror"
                                    id="vision_heading" name="vision_heading" value="{{ old('vision_heading', $case_study->vision_heading) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('vision_intro_paragraph') is-invalid @enderror"
                                    id="vision_intro_paragraph" name="vision_intro_paragraph" rows="4">{{ old('vision_intro_paragraph', $case_study->vision_intro_paragraph) }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <div id="vision-bullets-list">
                                    @foreach(old('vision_bullets', $case_study->vision_bullets ?? []) as $bullet)
                                        <div class="input-group mb-2 vision-bullet-row">
                                            <input type="text" class="form-control" name="vision_bullets[]" value="{{ is_string($bullet) ? $bullet : '' }}">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('vision_transition_text') is-invalid @enderror"
                                    id="vision_transition_text" name="vision_transition_text" rows="3">{{ old('vision_transition_text', $case_study->vision_transition_text) }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('vision_closing_line') is-invalid @enderror"
                                    id="vision_closing_line" name="vision_closing_line" value="{{ old('vision_closing_line', $case_study->vision_closing_line) }}">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('client_name') is-invalid @enderror"
                                            id="client_name" name="client_name" value="{{ old('client_name', $case_study->client_name) }}">
                                        @error('client_name')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('project_name') is-invalid @enderror"
                                            id="project_name" name="project_name" value="{{ old('project_name', $case_study->project_name) }}">
                                        @error('project_name')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('project_location') is-invalid @enderror"
                                            id="project_location" name="project_location" value="{{ old('project_location', $case_study->project_location) }}">
                            ...
                            <div id="sections-container" class="mb-3">
                                @php $sectionsForForm = old('sections') ?? $case_study->sections->toArray(); @endphp
                                @foreach($sectionsForForm as $i => $sec)
                                    @php
                                        $sec = is_array($sec) ? (object) $sec : $sec;
                                        $secId = $sec->id ?? '';
                                        $secTitle = $sec->title ?? '';
                                        $secContent = $sec->content ?? '';
                                        $secShowTitle = $sec->show_title ?? true;
                                        $secVisible = $sec->is_visible ?? true;
                                        $secOrder = $sec->order ?? $i;
                                    @endphp
                                    <div class="section-row card mb-3" data-section-index="{{ $i }}">
                                        ...
                                        <div class="card-body">
                                            <input type="hidden" class="section-id" name="sections[{{ $i }}][id]" value="{{ $secId }}">
                                            <input type="hidden" class="section-order" name="sections[{{ $i }}][order]" value="{{ $secOrder }}">
                                            <div class="mb-3">
                                                <label class="form-label">Section Title</label>
                                                <input type="text" class="form-control section-title" name="sections[{{ $i }}][title]" value="{{ $secTitle }}">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Content</label>
                                                <textarea class="form-control section-content rich-editor" name="sections[{{ $i }}][content]" id="section_content_{{ $i }}" rows="8">{!! $secContent !!}</textarea>
                                            </div>
                                            <div class="row">
                                                <div class="col-auto">
                                                    <div class="form-check">
                                                        <input class="form-check-input section-show-title" type="checkbox" name="sections[{{ $i }}][show_title]" value="1" {{ $secShowTitle ? 'checked' : '' }}>
                                                        <label class="form-check-label">Show Title</label>
                                                    </div>
                                                </div>
                                                <div class="col-auto">
                                                    <div class="form-check">
                                                        <input class="form-check-input section-is-visible" type="checkbox" name="sections[{{ $i }}][is_visible]" value="1" {{ $secVisible ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('meta_title') is-invalid @enderror"
                                            id="meta_title" name="meta_title" value="{{ old('meta_title', $case_study->meta_title) }}">
                                        @error('meta_title')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('meta_description') is-invalid @enderror"
                                            id="meta_description" name="meta_description" rows="2">{{ old('meta_description', $case_study->meta_description) }}</textarea>
                            ...
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="is_published" name="is_published" value="1" {{ old('is_published', $case_study->is_published) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="is_published">Published</label>
                                    </div>
                                </div>
                                <div class="col-auto">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="is_featured" name="is_featured" value="1" {{ old('is_featured', $case_study->is_featured) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="datetime-local" class="form-control @error('published_at') is-invalid @enderror"
                                            id="published_at" name="published_at" value="{{ old('published_at', $case_study->published_at?->format('Y-m-d\TH:i')) }}">
                                        @error('published_at')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
...
@section('scripts')
    ...
    <script>
    (function() {
        var sectionIndex = {{ $case_study->sections->count() }};
