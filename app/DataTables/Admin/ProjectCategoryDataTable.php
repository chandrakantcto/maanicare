...
{
    protected $dataTableId = 'ProjectCategoryDataTable';
        ...
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($row) {
                $actions = [
                    ...
                    'view_url'   => route('admin.project-categories.show', $row->id),
                    'edit_url'   => route('admin.project-categories.edit', $row->id),
                    'delete_url' => route('admin.project-categories.destroy', $row->id),
                ];
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
            ...
            ->ajax(DataTableHelper::getDataTableAjax(['url' => route('admin.project-categories.index'), 'method' => 'GET']))
